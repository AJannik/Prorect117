...
namespace Game.Tools
{
    ...
    public static class Transformation
    {
        ...
        public static Vector2 Transform(this Vector2 input, Matrix4 transformation) => Vector4.Transform(new Vector4(input.X, input.Y, 0f, 1f), transformation).Xy;

        public static Vector2 TransformDirection(this Vector2 input, Matrix4 transformation) => Vector4.Transform(new Vector4(input.X, input.Y, 0f, 0f), transformation).Xy;
    }
}